          ...
          <motion.form {...fadeUp(0.12)} onSubmit={handleEmailAuth} className="auth-email-form">
            <div>
              ...
              {isCompanyEmail(email) && (
                <p style={{ fontSize: "0.72rem", color: "hsl(var(--primary))", marginTop: "0.3rem", display: "flex", alignItems: "center", gap: "0.3rem", fontWeight: 500 }}>
                  <Sparkles size={12} /> Company email detected — auto-routing to Seller account
                </p>
              )}
            </div>
