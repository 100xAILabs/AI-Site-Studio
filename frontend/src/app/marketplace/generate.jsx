                          ...
                          <div className="flex items-center gap-1 p-0.5 rounded-lg bg-muted/40 border border-border">
                            <button
                              ...
                              className={`px-2.5 py-0.5 text-xs font-semibold rounded-md transition-colors ${
                                themeMode === "dark" ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground"
                              }`}
                            >
                              Dark
                            </button>
                            <button
                              ...
                              className={`px-2.5 py-0.5 text-xs font-semibold rounded-md transition-colors ${
                                themeMode === "light" ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground"
                              }`}
                            >
                              Light
                            </button>
